...
2. **Evaluate Career Narrative**: Assess whether the CV tells a cohesive, compelling story:
   ...
   - Does it justify the [redacted] increase target ([redacted] → [redacted] CHF)?
...
- **NEW**: Confirm overall career narrative supports [redacted] CHF salary target
...
- Target salary: CHF [redacted] (opening position)

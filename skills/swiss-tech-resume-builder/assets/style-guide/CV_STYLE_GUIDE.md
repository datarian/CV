...
This style guide documents the visual design system used in Jane Smith's CV documents. The design emphasizes **clean modernism**, **professional readability**, and **Swiss design principles** with a distinctive light blue accent color.
...
- LaTeX: `\firstname{Jane}` + `\familyname{Smith}`
...
\cvitem{LLM \& GenAI}{Enterprise LLM (1+ year production) \textbullet{} 
...
For questions or suggestions, contact: jane.smith@example.com
